            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="topbar-nav topbar-left">
                        <li class="disabled"><a href="#"><i class="fa fa-envelope"></i> info@slinardipropiedades.com</a></li>
                        <li class="disabled"><a href="#"><i class="fa fa-phone"></i> 4483-2526 - 15 3547-4637</a></li>
                    </ul>

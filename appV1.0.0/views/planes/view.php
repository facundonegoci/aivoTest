                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="precio" placeholder="0.00" class="form-control" type="number">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="limite" placeholder="0" class="form-control" type="number">
                            </div>
                        </div>

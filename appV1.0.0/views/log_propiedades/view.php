    ...
    function edit_obj(id)
    {
        ...
        $.ajax({
            ...
            success: function (data)
            {
                ...
                $('[name="propiedad_id"]').val(data.propiedad_id);
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">User_agente</label>
                            <div class="col-md-9">
                                <input name="user_agent" placeholder="user_agente" class="form-control" type="text" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Propiedad_id</label>
                            <div class="col-md-9">
                                <input name="propiedad_id" placeholder="propiedad_id" class="form-control" type="text" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Accion</label>
                            <div class="col-md-9">
                                <input name="accion" placeholder="accion" class="form-control" type="text" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Ip</label>
                            <div class="col-md-9">
                                <input name="ip" placeholder="ip" class="form-control" type="text" required="">
                            </div>
                        </div>
